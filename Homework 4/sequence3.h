// PROVIDED BY:Tahsin Parvez tparvez000@citymail.cuny.edu
// FILE: sequence3.h
...
namespace main_savitch_5
{
    ...
    public:
        ...
        value_type current( ) const;
    private:
        // will designate which node each function will keep track of
        node *head_ptr;
        // will keep track of first node
        node *tail_ptr;
        // will keep track of second 
        node *cursor; 
